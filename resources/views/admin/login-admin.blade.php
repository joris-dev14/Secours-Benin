...
<head>
    ...
    <title>Connexion Administrateur - Secours Bénin</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;600;700&display=swap" rel="stylesheet">
    <style>
        :root { --primary-blue: #0A2540; --accent-red: #FF5252; --white: #FFFFFF; }
        body { font-family: 'Poppins', sans-serif; background: linear-gradient(135deg, var(--primary-blue) 0%, #1a3a5c 100%); color: var(--white); height: 100vh; display: flex; align-items: center; justify-content: center; }
...
<body>
    <div class="login-card">
        <div class="logo-container">
            ...
            <p class="text-muted small">Portail Administration - Direction SAMU</p>
        </div>
    ...
    <div class="mb-3">
        <label class="form-label fw-semibold">Identifiant administrateur</label>
        <input type="text" name="matricule" class="form-control" placeholder="ex: ADMIN-001" required>
    </div>
    <div class="mb-4">
