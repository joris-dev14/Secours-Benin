...
<head>
    ...
    <meta name="apple-mobile-web-app-title" content="Secours Bénin">
    ...
    <nav class="navbar navbar-expand-lg navbar-custom fixed-top" id="mainNav">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <a href="{{url('/citoyen/nouvelle-alerte')}}" class="btn btn-cta">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6" data-aos="fade-right">
                    ...
                    <div class="d-flex gap-3 flex-wrap">
                        <a href="{{ url('/citoyen/nouvelle-alerte')}}" class="btn btn-hero-primary">
                            <i class="fa-solid fa-bolt me-2"></i>Signaler une urgence
                        </a>
                        <a href="{{ url('/fonctionnalites')}}" class="btn btn-hero-secondary">
        ...
        <div class="container">
            <div class="row g-4">
                ...
                <div class="col-lg-3 col-md-4">
                    <h5>Plateforme</h5>
                    <a href="{{ url('/citoyen/nouvelle-alerte') }}">Espace Citoyen</a>
                    <a href="{{ url('/regulateur/dashboard') }}">Espace Régulateur</a>
                    <a href="{{ url('/ambulancier/missions') }}">Espace Ambulancier</a>
                    <a href="{{ url('/admin/dashboard') }}">Espace Administrateur</a>
                </div>
                <div class="col-lg-3 col-md-4">
                    <h5>Contact</h5>
            ...
            <button id="btnInstaller" style="display:none;" class="btn btn-primary fw-bold">
            <i class="fa-solid fa-download me-2"></i> Installer l'application
            </button>
        </div>
    </footer>
