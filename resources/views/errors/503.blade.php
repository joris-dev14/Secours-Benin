...
<head>
    ...
    <title>Service indisponible - Secours Bénin</title>
    ...
    <style>
        ...
        .error-code { font-size: 6rem; font-weight: 800; color: #10B981; line-height: 1; }
...
<body>
    <div class="error-card">
        ...
        <i class="fa-solid fa-heart-pulse fa-3x text-success my-3"></i>
        <h3 class="fw-bold mb-2">Service temporairement indisponible</h3>
        <p class="text-muted mb-4">Secours Bénin est en cours de maintenance. Nous revenons très bientôt.</p>
        <a href="/" class="btn-home"><i class="fa-solid fa-rotate me-2"></i> Réessayer</a>
    </div>
</body>
</html>