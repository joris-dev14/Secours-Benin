...
<head>
    ...
    <title>Session expirée - Secours Bénin</title>
    ...
    <style>
        ...
        .error-code { font-size: 6rem; font-weight: 800; color: #3b82f6; line-height: 1; }
...
<body>
    <div class="error-card">
        ...
        <i class="fa-solid fa-clock-rotate-left fa-3x text-primary my-3"></i>
        <h3 class="fw-bold mb-2">Session expirée</h3>
        <p class="text-muted mb-4">Votre session a expiré. Veuillez recharger la page et réessayer.</p>
        <a href="javascript:history.back()" class="btn-home"><i class="fa-solid fa-rotate-left me-2"></i> Retour en arrière</a>
    </div>
</body>
</html>