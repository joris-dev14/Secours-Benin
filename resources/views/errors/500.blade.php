...
<head>
    ...
    <title>Erreur serveur - Secours Bénin</title>
...
<body>
    <div class="error-card">
        ...
        <i class="fa-solid fa-triangle-exclamation fa-3x text-danger my-3"></i>
        <h3 class="fw-bold mb-2">Erreur serveur</h3>
        <p class="text-muted mb-4">Une erreur interne s'est produite. Notre équipe technique a été notifiée.</p>
