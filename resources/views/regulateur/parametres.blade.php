...
<body>
    <nav class="sidebar" id="sidebar">
        ...
        <div class="d-flex flex-column mt-3">
            ...
            <a href="/regulateur/parametres" class="nav-link active"><i class="fa-solid fa-gear"></i> Paramètres</a>
            <div class="mt-auto">
                <a href="/regulateur/deconnexion" class="nav-link text-danger"><i class="fa-solid fa-right-from-bracket"></i> Déconnexion</a>
            </div>
        </div>
    </nav>
    ...
    <h3 class="fw-bold mb-0">Paramètres du compte</h3>
        ...
        <div class="param-card">
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" value="{{ $regulateur->nom }}" disabled>
                </div>
                <div class="col-md-6">
                    <label class="form-label fw-semibold">Prénom</label>
                    <input type="text" class="form-control" value="{{ $regulateur->prenom }}" disabled>
                </div>
                <div class="col-md-6">
                    <label class="form-label fw-semibold">Matricule</label>
                    <input type="text" class="form-control" value="{{ $regulateur->matricule }}" disabled>
                </div>
                <div class="col-md-6">
                    <label class="form-label fw-semibold">Centre</label>
                    <input type="text" class="form-control" value="{{ $regulateur->centre }}" disabled>
                </div>
            </div>
        </div>
        ...
        <div class="param-card">
            ...
            <form method="POST" action="/regulateur/parametres">
                @csrf
                <div class="row g-3">
                    <div class="col-md-12">
